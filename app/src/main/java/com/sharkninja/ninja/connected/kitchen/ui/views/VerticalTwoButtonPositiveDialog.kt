...
import com.sharkninja.ninja.connected.kitchen.databinding.DialogVerticalTwoButtonPositiveBinding
import com.sharkninja.ninja.connected.kitchen.ext.toPx

class VerticalTwoButtonPositiveDialog(
    private val configuration: Configuration.() -> Unit
) : DialogFragment() {
    private lateinit var binding: DialogVerticalTwoButtonPositiveBinding
    ...
    override fun onCreateView(
        ...
        binding = DialogVerticalTwoButtonPositiveBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    class Configuration {
        ...
        var topButtonColor: Int = R.color.error_red
    }
