package com.sharkninja.ninja.connected.kitchen.sections.explore.dialogs
...
class GrillAccessoryDialogCharts : DialogFragment() {
    ...
    private fun initBindings() {
        ...
        binding.doneButton.setOnClickListener {
            dismissNow()
            homeViewModel.updateAction(CookDashboardInfoAction.StartCookFromChart)
        }
    }
}