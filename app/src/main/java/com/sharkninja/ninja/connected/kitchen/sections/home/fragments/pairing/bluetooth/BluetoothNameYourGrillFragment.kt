...
class BluetoothNameYourGrillFragment : Fragment() {
    ...
    private fun initBindings() {
        ...
        binding.continueButton.setOnClickListener {
            ...
            lifecycleScope.launchWhenStarted {
                delay(3000)
                dialog.dismiss()
                findNavController().safeNavigate(NameYourGrillFragmentDirections.actionNameYourGrillFragmentToWifiOptionFragment())
            }
        }
    }
}