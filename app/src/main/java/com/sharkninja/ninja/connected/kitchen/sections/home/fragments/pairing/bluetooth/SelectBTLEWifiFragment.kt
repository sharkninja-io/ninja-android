...
import com.sharkninja.ninja.connected.kitchen.databinding.FragmentSelectBtleWifiBinding
...
class SelectBTLEWifiFragment : Fragment() {

    private lateinit var binding: FragmentSelectBtleWifiBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSelectBtleWifiBinding.inflate(inflater, container, false)
        initBindings()
        return binding.root
    }
    ...
    private fun initBindings() {
        binding.networkTipsText.setOnClickListener {
            findNavController().safeNavigate(SelectBTLEWifiFragmentDirections.actionSelectBTLEWifiFragmentToNetworkTipsDialogFragment())
        }
    ...
    private fun subscribeToVM() {
        ...
        homeViewModel.selectedUserWifiNetwork.observe(viewLifecycleOwner) { selectedWifiNetwork ->
            selectedWifiNetwork?.let {
                if (it.ssid != null) {
                    findNavController().safeNavigate(SelectBTLEWifiFragmentDirections.actionSelectBTLEWifiFragmentToEnterBTLEWifiPasswordFragment())
                }
            }
        }
