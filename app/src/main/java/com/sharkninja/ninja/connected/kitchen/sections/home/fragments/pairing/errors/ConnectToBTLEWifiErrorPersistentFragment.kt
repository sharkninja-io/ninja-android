...
class ConnectToBTLEWifiErrorPersistentFragment : Fragment() {
    ...
    private fun initBindings() {
        binding.buttonTryAgain.setOnClickListener {
            findNavController().safeNavigate(ConnectToBTLEWifiErrorPersistentFragmentDirections
                .actionConnectToBTLEWifiErrorPersistentFragmentToSelectBTLEWifiFragment())
        }
