...
class PlugInThermometer1Dialog: DialogFragment() {
    ...
    private fun initBindings() {
        ...
        binding.dialogDescription.text = getString(R.string.dialog_thermometer_1_not_plugged_in_dashboard_description)
