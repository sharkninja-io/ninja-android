...
import com.sharkninja.ninja.connected.kitchen.databinding.FragmentConnectToBtleWifiInternationalBinding
...
class ConnectToBTLEWifiInternationalFragment : Fragment() {

    private lateinit var binding: FragmentConnectToBtleWifiInternationalBinding
    ...
    private val countDown = object : CountDownTimer(COUNT_DOWN_LENGTH, COUNT_DOWN_INTERVAL) {
        ...
        override fun onFinish() {
            findNavController().safeNavigate(
                ConnectToBTLEWifiInternationalFragmentDirections
                    .actionConnectToBTLEWifiInternationalFragmentToConnectToBTLEWifiInternationalErrorPersistentFragment()
            )
        }
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentConnectToBtleWifiInternationalBinding.inflate(inflater, container, false)
        initBindings()
                        ...
                        binding.ellipseWaiting.animate().scaleX(0f).scaleY(0f).setDuration(500)
                            .withEndAction {
                                ...
                                binding.goToDashboardButton.setOnClickListener {
                                    ...
                                    findNavController().safeNavigate(ConnectToBTLEWifiInternationalFragmentDirections.globalToHomeFragment())
                                }
                            }.start()
                    }
                }
    ...
    private fun onConnectionFailure() {
        when {
            homeViewModel.wifiErrorCount == 1 -> {
                findNavController().safeNavigate(ConnectToBTLEWifiInternationalFragmentDirections.actionConnectToBTLEWifiInternationalFragmentToConnectToBTLEWifiInternationalErrorFirstFragment())
            }
            homeViewModel.wifiErrorCount >= 2 -> {
                findNavController().safeNavigate(ConnectToBTLEWifiInternationalFragmentDirections.actionConnectToBTLEWifiInternationalFragmentToConnectToBTLEWifiInternationalErrorPersistentFragment())
            }
        }
    }
}