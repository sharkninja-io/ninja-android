...
class EnterBTLEWifiInternationalPasswordFragment : Fragment(), PasswordEditTextInterface {
    ...
    private fun initBindings() {
        binding.enterWifiPasswordEditText.apply {
            ...
            delegate = this@EnterBTLEWifiInternationalPasswordFragment
        ...
        binding.buttonConnect.setOnClickListener {
            homeViewModel.logPairingEvent("${EnterBTLEWifiInternationalPasswordFragment::class.java.simpleName}: Wifi password entered. Connect Button Clicked")
            homeViewModel.onConnectWifi(
                password = binding.enterWifiPasswordEditText.editText.text.toString()
            )
            findNavController().safeNavigate(EnterBTLEWifiInternationalPasswordFragmentDirections.actionEnterBTLEWifiInternationalPasswordFragmentToConnectToBTLEWifiInternationalFragment())
        }
    }
