...
class ConnectToBluetoothInternationalErrorFirstFragment : Fragment() {
    ...
    private fun initBindings() {
        binding.buttonTryAgain.setOnClickListener {
            findNavController().safeNavigate(ConnectToBluetoothInternationalErrorFirstFragmentDirections.actionConnectToBluetoothInternationalErrorFirstFragmentToBluetoothInternationalFindDevicesFragment())
        }
    }
}