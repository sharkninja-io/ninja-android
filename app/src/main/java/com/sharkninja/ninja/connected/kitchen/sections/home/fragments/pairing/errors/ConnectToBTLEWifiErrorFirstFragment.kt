...
class ConnectToBTLEWifiErrorFirstFragment : Fragment() {
    ...
    private fun initBindings() {
        binding.buttonTryAgain.setOnClickListener {
            findNavController().safeNavigate(ConnectToBTLEWifiErrorFirstFragmentDirections
                .actionConnectToBTLEWifiErrorFirstFragmentToSelectBTLEWifiFragment())
        }
    }
}