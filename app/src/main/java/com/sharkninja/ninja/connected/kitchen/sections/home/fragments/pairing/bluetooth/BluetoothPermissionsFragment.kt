...
import com.sharkninja.ninja.connected.kitchen.databinding.FragmentBluetoothPermissionsBinding
...
class BluetoothPermissionsFragment : Fragment() {

    private lateinit var binding: FragmentBluetoothPermissionsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBluetoothPermissionsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initBindings() {
        ...
        binding.buttonNext.setOnClickListener {
            ...
            val directions = BluetoothPermissionsFragmentDirections.actionPermissionsToPairingPreparation()
    ...
    private fun onNearbyDevicesDenied() {
        val directions = BluetoothPermissionsFragmentDirections.actionBluetoothPermissionsFragmentToNearbyDevicesErrorFragment()
        findNavController().safeNavigate(directions)
    }
    ...
    private fun onLocationDenied() {
        val directions = BluetoothPermissionsFragmentDirections.actionBluetoothPermissionsFragmentToLocationPermissionErrorFragment()
        findNavController().safeNavigate(directions)
    }

    private fun showBluetoothDisabledDialog() {
        val directions = BluetoothPermissionsFragmentDirections.actionOpenBluetoothDisabledDialog()
        findNavController().safeNavigate(directions)
    }
}